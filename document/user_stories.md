...
## Rastreabilidade — User Stories × MVP da Sprint 3

| User Story | Critério | Situação no MVP |
|---|---|---|
| US-01 | CA-01.1, CA-01.2, CA-01.3 | **Parcial:** classe, score, recomendação e alerta visual implementados; som e vibração permanecem no backlog |
| US-01 | CA-01.4 | **Implementado:** importância global no notebook e no dashboard; explicação local por predição permanece no backlog |
| US-02 | CA-02.1 | **Parcial:** histórico SQLite implementado; visão consolidada por frota permanece no backlog |
| US-02 | CA-02.2, CA-02.3 | **Backlog:** ranking e drilldown por equipamento não fazem parte do recorte de 60% deste MVP |
| US-02 | CA-02.4 | **Parcial:** indicadores por variável e query analítica disponíveis |
| US-03 | CA-03.1, CA-03.3 | **Parcial:** schema e consultas preparados; aderência e análise forense completas permanecem no backlog |
| US-03 | CA-03.2 | **Implementado:** score consolidado de risco entre 0 e 100 |
| US-03 | CA-03.4 | **Parcial:** entradas, classe, score, recomendação e fontes auditadas no SQLite; probabilidades e versão previstas no schema Oracle opcional |
